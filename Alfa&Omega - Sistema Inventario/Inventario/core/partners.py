...
from .database import get_connection, DB_ENGINE
...
def ensure_schema() -> None:
    ...
    """
    # Si estamos en Postgres, dejamos que Alembic maneje el esquema
